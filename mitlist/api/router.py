...
api_router.include_router(chores_api.router)
api_router.include_router(documents_api.router)
api_router.include_router(finance_api.router)
api_router.include_router(gamification_api.router)
api_router.include_router(governance_api.router)
api_router.include_router(lists_api.router)
api_router.include_router(lists_api.inventory_router)
api_router.include_router(notifications_api.router)
api_router.include_router(pets_api.router)
api_router.include_router(plants_api.router)
