...
@router.get("/assignments", response_model=list[schemas.ChoreAssignmentWithChoreResponse])
async def get_chore_assignments(
    ...
    db: AsyncSession = Depends(get_db),
) -> list[schemas.ChoreAssignmentWithChoreResponse]:
...
@router.get("/history", response_model=list[schemas.ChoreAssignmentWithChoreResponse])
...
# ---------- Dependencies ----------
@router.get("/{chore_id}/dependencies", response_model=list[schemas.ChoreDependencyResponse])
...
# ---------- Templates ----------
@router.get("/templates", response_model=list[schemas.ChoreTemplateResponse])
