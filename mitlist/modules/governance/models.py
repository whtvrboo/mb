...
class Proposal(BaseModel, TimestampMixin):
    ...
    min_quorum_percentage: Mapped[int | None] = mapped_column(nullable=True)
    linked_expense_id: Mapped[int | None] = mapped_column(nullable=True)  # FK to expenses
    linked_chore_id: Mapped[int | None] = mapped_column(nullable=True)  # FK to chores
    linked_pet_id: Mapped[int | None] = mapped_column(nullable=True)  # FK to pets
...
class BallotOption(BaseModel, TimestampMixin):
    ...
    option_metadata: Mapped[dict | None] = mapped_column(JSON, nullable=True)
...
class VoteRecord(BaseModel, TimestampMixin):
    ...
    rank_order: Mapped[int | None] = mapped_column(nullable=True)  # For ranked choice
