...
class AuditLog(BaseModel, TimestampMixin):
    ...
    # Optimization: Composite index for efficient entity history lookup and sorting
    __table_args__ = (
        Index("ix_audit_logs_entity_history", "entity_type", "entity_id", "occurred_at"),
    )
...
class TagAssignment(BaseModel, TimestampMixin):
    ...
    # Optimization: Composite index for polymorphic association lookup
    __table_args__ = (Index("ix_tag_assignments_entity", "entity_type", "entity_id"),)
