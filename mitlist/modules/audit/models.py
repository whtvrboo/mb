...
class AuditLog(BaseModel, TimestampMixin):
    ...
    __table_args__ = (
        Index("ix_audit_logs_group_occurred_at", "group_id", "occurred_at"),
        Index("ix_audit_logs_entity_lookup", "entity_type", "entity_id", "occurred_at"),
    )
...
class TagAssignment(BaseModel, TimestampMixin):
    ...
    __table_args__ = (
        Index("ix_tag_assignments_entity_lookup", "entity_type", "entity_id"),
    )
