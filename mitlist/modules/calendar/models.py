...
class CalendarEvent(BaseModel, TimestampMixin):
    ...
    linked_asset_id: Mapped[int | None] = mapped_column(nullable=True)  # FK to home_assets
    linked_pet_id: Mapped[int | None] = mapped_column(
...
class EventAttendee(BaseModel, TimestampMixin):
    ...
    rsvp_at: Mapped[datetime | None] = mapped_column(nullable=True)
