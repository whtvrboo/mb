...
const rotationPreview = [
    { name: 'Alex (You)', dates: 'Oct 1-7', type: 'Current', isNext: false, isUser: true },
    { name: 'Sam', dates: 'Oct 8-14', type: 'Next', isNext: true, isUser: false },
    { name: 'Jamie Doe', dates: 'Oct 15-21', type: 'Later', isNext: false, isUser: false },
]
        ...
        <main class="flex flex-col gap-8 p-5 max-w-lg mx-auto w-full">
                ...
                <label class="cursor-pointer group relative">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-xs font-medium opacity-80 leading-snug">Assignments rotate cyclically every
                                period.</p>
                        </div>
                    </div>
                </label>
            ...
            <section class="flex flex-col gap-4">
                <div class="flex items-center justify-between border-b-[3px] border-background-dark pb-2">
                    ...
                    <span
                        class="bg-primary px-2 py-0.5 text-xs font-bold border-[2px] border-background-dark rounded shadow-neobrutalism-sm">OCTOBER</span>
                </div>
