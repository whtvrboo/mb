    ...
    <div class="flex items-start justify-between gap-3">
      <div class="flex items-start gap-3 flex-1">
        ...
        <div class="relative mt-1 shrink-0">
          ...
          <label
            :for="checkboxId"
            class="cursor-pointer size-6 border-2 border-background-dark rounded bg-white peer-checked:bg-primary transition-colors flex items-center justify-center peer-focus-visible:ring-2 peer-focus-visible:ring-offset-2 peer-focus-visible:ring-background-dark"
        ...
        <div class="flex flex-col">
          <label
            :for="checkboxId"
            class="text-xl font-bold leading-tight transition-colors cursor-pointer"
