...
from mitlist.modules.gamification.models import Achievement, AchievementCategory, RequirementType, UserPoints
...
@pytest.mark.asyncio
async def test_gamification_n_plus_one_benchmark(db: AsyncSession, test_user: User, test_group: Group):
