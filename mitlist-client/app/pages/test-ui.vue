    ...
    <div class="p-10 space-y-12 max-w-4xl mx-auto pb-32">
        ...
        <section class="space-y-4">
            ...
            <UiModal v-model="showModal" title="Example Modal">
                ...
                <template #footer>
                    ...
                    <UiButton @click="showModal = false">Confirm</UiButton>
                </template>
            </UiModal>
        </section>
        ...
        <section class="space-y-4">
            ...
            <div class="flex gap-2">
                <UiButton @click="{ showToast = true; toastVariant = 'success' }"
                    class="bg-sage text-white border-sage">Success</UiButton>
                <UiButton @click="{ showToast = true; toastVariant = 'error' }"
                    class="bg-red-200 text-red-900 border-red-900">Error</UiButton>
                <UiButton @click="{ showToast = true; toastVariant = 'warning' }"
                    class="bg-orange-200 text-orange-900 border-orange-900">Warning</UiButton>
            </div>
            <UiToast v-model="showToast" :variant="toastVariant" title="Notification"
        ...
        <section class="space-y-4">
            ...
            <UiDropdown label="Options" icon="menu" :items="dropdownItems" />
        </section>
        ...
        <section class="space-y-4">
            ...
            <div class="max-w-xs">
                <UiSelect v-model="selectedFruit" :options="fruits" label="Favorite Fruit" />
            </div>
        ...
        <section class="space-y-4">
            ...
            <div class="flex flex-col gap-4">
                <UiCheckbox v-model="isChecked" label="Agree to Terms" />

                <div class="flex gap-6">
                    <UiCheckbox v-model="selectedRoles" value="admin" label="Admin" />
                    <UiCheckbox v-model="selectedRoles" value="editor" label="Editor" />
                    <UiCheckbox v-model="selectedRoles" value="viewer" label="Viewer" />
                </div>
                <p class="text-sm font-mono">Roles: {{ selectedRoles }}</p>

                <div class="flex gap-6 mt-2">
                    <UiRadio v-model="selectedPlan" value="free" label="Free Plan" name="plan" />
                    <UiRadio v-model="selectedPlan" value="pro" label="Pro Plan" name="plan" />
                </div>
        ...
        <section class="space-y-4">
            ...
            <UiPagination v-model:currentPage="currentPage" :totalPages="10" />
