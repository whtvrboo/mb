  ...
  >
    ...
    >
      <div class="flex items-center gap-3">
        <NuxtLink to="/" aria-label="Back to dashboard" class="flex items-center justify-center size-10 rounded-lg border-[2px] border-transparent hover:border-background-dark hover:bg-black/5 transition-colors">
      ...
      <button class="size-10 flex items-center justify-end" aria-label="Search recipes">
    ...
    <main class="flex flex-col gap-8 p-5 max-w-lg mx-auto w-full">
      ...
      <section class="flex flex-col gap-4">
        ...
        >
          <span class="material-symbols-outlined">calendar_month</span> Weekly
          Menu
        </h2>
      ...
      <section class="flex flex-col gap-4">
        <div class="flex items-center justify-between">
          ...
          <button aria-label="Create new recipe" class="bg-primary px-3 py-1 rounded border-[2px] border-background-dark font-bold text-xs uppercase shadow-sm hover:translate-y-0.5 hover:shadow-none transition-all">
            + New
          </button>
        </div>

        <div v-if="isLoading" role="status" aria-live="polite" class="text-center py-10 opacity-50">
          Loading recipes...
        </div>
        <div
