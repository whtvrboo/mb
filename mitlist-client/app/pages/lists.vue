      ...
      <div
        ...
        <div class="flex gap-3">
          <div class="relative flex-1">
            ...
            <input :id="inputId" v-model="newItemName" @keyup.enter="handleAddItem"
              :disabled="isLoading || !currentListId || isAdding"
          ...
          <button @click="handleAddItem" :disabled="isLoading || !currentListId || isAdding" aria-label="Add item"
            ...
            <span v-if="!isAdding"
              class="material-symbols-outlined text-background-dark text-3xl font-bold">add</span>
            <div v-else
              class="size-6 border-2 border-background-dark border-t-transparent rounded-full animate-spin"></div>
          </button>
        </div>
