    ...
    <div
      ...
      <header
        ...
        <div class="flex items-center justify-between mb-4">
          <NuxtLink to="/" aria-label="Go back to dashboard"
          ...
          <div class="flex -space-x-3">
            <div v-for="(member, idx) in members.slice(0, 3)" :key="member.user_id"
              ...
              :style="{ zIndex: 30 - idx }"
              :title="member.user?.name || 'Group member'">
              ...
              <span v-else :aria-label="member.user?.name || 'Member'">{{ member.user?.name?.[0] || '?' }}</span>
            </div>
      ...
      <div
        ...
        <div class="flex gap-3">
          <div class="relative flex-1">
            ...
            <input id="new-item-input" v-model="newItemName" @keyup.enter="handleAddItem" :disabled="isLoading || isAdding || !currentListId"
