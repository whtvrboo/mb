      ...
      <div
        ...
        <div class="flex gap-3">
          <div class="relative flex-1">
            <input v-model="newItemName" @keydown.enter.prevent="handleAddItem" :disabled="isLoading || isAdding || !currentListId"
          ...
          <button @click="handleAddItem" :disabled="isLoading || isAdding || !currentListId"
            ...
            <div v-if="isAdding" class="size-6 border-4 border-background-dark border-t-transparent rounded-full animate-spin"></div>
