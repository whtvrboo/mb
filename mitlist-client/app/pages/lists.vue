      ...
      <div
        ...
        <div class="flex gap-3">
          <div class="relative flex-1">
            <label :for="newItemId" class="sr-only">Add new item</label>
            <input :id="newItemId" v-model="newItemName" @keyup.enter="handleAddItem" :disabled="isLoading || !currentListId || isAddingItem"
          ...
          <button @click="handleAddItem" :disabled="isLoading || !currentListId || isAddingItem"
            :aria-label="isAddingItem ? 'Adding item...' : 'Add item'"
            ...
            <span v-if="isAddingItem" class="animate-spin h-8 w-8 text-background-dark">
