          ...
          <div class="flex -space-x-3">
            <div v-for="(member, idx) in members.slice(0, 3)" :key="member.user_id"
              ...
              <span v-if="member.user?.avatar_url">
                <img :src="member.user.avatar_url" :alt="member.user?.name || 'User avatar'" class="w-full h-full object-cover" />
              </span>
      ...
      <div
        ...
        <div class="flex gap-3">
          <div class="relative flex-1">
            <input v-model="newItemName" @keyup.enter="handleAddItem" :disabled="isLoading || !currentListId" aria-label="New item name"
          ...
          <button @click="handleAddItem" :disabled="isLoading || !currentListId" aria-label="Add item"
