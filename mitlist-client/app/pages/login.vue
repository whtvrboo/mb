  ...
  <div
    ...
    <div class="absolute top-[-80px] left-[-60px] opacity-5 pointer-events-none z-0 -rotate-12">
      <svg fill="none" height="300" viewBox="0 0 200 200" width="300" xmlns="http://www.w3.org/2000/svg">
        <circle cx="100" cy="100" r="80" stroke="#221f10" stroke-width="8"/>
        <path d="M100 20L100 180M20 100L180 100" stroke="#221f10" stroke-width="8"/>
      </svg>
    </div>
    ...
    <main class="flex-1 px-6 pt-4 pb-8 flex flex-col relative z-10 w-full max-w-md mx-auto">
      ...
      <div class="flex items-end justify-between mb-8 mt-2">
        ...
        <div class="relative w-24 h-24 mb-1 shrink-0 -mr-2">
          <svg
class="w-full h-full drop-shadow-[4px_4px_0px_rgba(34,31,16,1)]" fill="none" viewBox="0 0 100 100"
            xmlns="http://www.w3.org/2000/svg">
            <circle cx="50" cy="40" r="20" fill="#eecd2b" stroke="#221f10" stroke-width="3"/>
            <circle cx="50" cy="40" r="8" fill="#221f10"/>
            <path
d="M50 60V90H30V75H50" stroke="#221f10" stroke-width="6" stroke-linecap="round"
...
:for="passwordId"
          ...
          <div class="relative">
            <input
:id="passwordId" v-model="password" :type="showPassword ? 'text' : 'password'"
              class="w-full h-14 bg-white border-[3px] border-background-dark rounded-xl px-4 text-lg font-bold placeholder:text-gray-300 placeholder:font-medium focus:ring-0 focus:border-primary focus:outline-none shadow-neobrutalism transition-all"
              placeholder="••••••••" >
            <button
type="button" :aria-label="showPassword ? 'Hide password' : 'Show password'"
        ...
        <button
          ...
          <div class="absolute top-2 left-2 right-2 h-[3px] bg-white/10 rounded-full"/>
      ...
      <div v-if="devAuthEnabled" class="relative py-6 flex items-center justify-center">
        <div class="absolute inset-0 flex items-center">
          <div class="w-full border-t-[3px] border-dashed border-background-dark/20"/>
        </div>
        <div
      ...
      <button
v-if="devAuthEnabled" type="button" class="group w-full bg-amber-50 border-[3px] border-amber-400 rounded-xl p-4 shadow-neobrutalism flex items-center justify-between active:translate-x-[2px] active:translate-y-[2px] active:shadow-neobrutalism-sm transition-all text-left relative"
