...
<template>
  ...
  >
    ...
    <div
      class="absolute top-[-80px] left-[-60px] opacity-5 pointer-events-none z-0 -rotate-12"
    >
      <svg
        fill="none"
        height="300"
      ...
      >
        ...
        ></circle>
        <path
          d="M100 20L100 180M20 100L180 100"
          stroke="#221f10"
          stroke-width="8"
        ></path>
      </svg>
    ...
    <!-- Header -->
    <header
      class="relative z-10 px-6 pt-8 pb-2 flex items-center justify-between"
    >
      <NuxtLink
        to="/"
      ...
      >
        <span
          class="material-symbols-outlined text-[24px] group-hover:-translate-x-0.5 transition-transform"
          aria-hidden="true"
          >home</span
        >
      </NuxtLink>
    ...
    <main
      class="flex-1 px-6 pt-4 pb-8 flex flex-col relative z-10 w-full max-w-md mx-auto"
    >
      <!-- Title Section -->
      <div class="flex items-end justify-between mb-8 mt-2">
        <div class="flex flex-col gap-1 z-10">
          <h1 class="text-[40px] font-bold leading-[0.9] tracking-tight">
            Welcome<br />Back
          </h1>
          <p class="text-sm font-bold opacity-60 mt-2 max-w-[200px]">
        ...
        <div class="relative w-24 h-24 mb-1 shrink-0 -mr-2">
          <svg
            class="w-full h-full drop-shadow-[4px_4px_0px_rgba(34,31,16,1)]"
            fill="none"
            viewBox="0 0 100 100"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      <form class="flex flex-col gap-5 w-full" @submit.prevent>
        <div class="flex flex-col gap-1.5 group">
          ...
          <div class="relative">
            <input
              ...
              placeholder="hello@mitlist.com"
              type="email"
            />
            <span
              class="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none group-focus-within:text-primary transition-colors"
              >mail</span
            >
          </div>
        </div>
        ...
        <div class="flex flex-col gap-1.5 group">
          ...
          <div class="flex justify-end">
            <a
              href="#"
              class="text-xs font-bold uppercase hover:text-primary transition-colors"
              >Forgot Pwd?</a
            >
          </div>
        </div>
        ...
        >
          <div
            class="absolute top-2 left-2 right-2 h-[3px] bg-white/10 rounded-full"
          ></div>
          <span
            class="relative font-black text-xl uppercase tracking-wider flex items-center gap-3"
          >
            Log In
            <div
              class="bg-white text-background-dark rounded-full p-1 group-hover:translate-x-1 transition-transform"
            >
              <span
                class="material-symbols-outlined text-[20px] block font-bold"
                >arrow_forward</span
              >
            </div>
          </span>
      ...
      <div
        v-if="devAuthEnabled"
        class="relative py-6 flex items-center justify-center"
      >
        <div class="absolute inset-0 flex items-center">
          <div
            class="w-full border-t-[3px] border-dashed border-background-dark/20"
          ></div>
        </div>
        <div
      ...
      >
        <span class="font-bold text-lg text-background-dark"
          >Sign up with Zitadel</span
        >
        <span class="material-symbols-outlined text-2xl text-background-dark"
          >person_add</span
        >
      </button>
