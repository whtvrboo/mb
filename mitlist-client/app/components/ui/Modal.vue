...
<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <div
          class="relative w-full bg-white border-[3px] border-background-dark rounded-xl shadow-[8px_8px_0px_0px_#221f10] overflow-hidden"
          :class="[width]"
          @click.stop
        >
          <!-- Header -->
          ...
          >
            <h3
              v-if="title"
              class="text-xl font-bold uppercase tracking-tight truncate"
            >
              {{ title }}
            </h3>
            <button
