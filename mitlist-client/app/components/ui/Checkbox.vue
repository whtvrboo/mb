    ...
    <div class="flex items-center gap-3">
        <div class="relative flex items-center">
            <input type="checkbox" :id="inputId" :checked="isChecked" :value="value" :disabled="disabled"
                @change="handleChange"
                class="peer appearance-none size-6 border-[3px] border-background-dark rounded bg-white checked:bg-primary transition-colors cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-background-dark focus:outline-none" />
