...
## 2026-02-13 - Focus Styles for Custom Form Controls
**Learning:** Custom form controls using `appearance-none` remove default browser focus indicators, making them inaccessible to keyboard users.
**Action:** Explicitly implement `focus-visible` styles (e.g., `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2`) on the input element to restore accessibility without affecting mouse users.
