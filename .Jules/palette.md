...
## 2026-02-04 - Custom Form Control Focus
**Learning:** Hiding default form inputs with `appearance-none` removes the browser's default focus ring, making keyboard navigation impossible.
**Action:** Always implement `focus-visible` styles (e.g., `focus-visible:ring-2`) on custom form controls to restore accessibility without affecting mouse users.
