...
down_revision: str | None = "009_assets"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_inventory_items_group_id"), "inventory_items", ["group_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_meal_plan_shopping_syncs_meal_plan_id"),
        "meal_plan_shopping_syncs",
        ["meal_plan_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_meal_plan_shopping_syncs_list_id"),
        "meal_plan_shopping_syncs",
        ["list_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_meal_plan_shopping_syncs_list_id"), table_name="meal_plan_shopping_syncs"
    )
    op.drop_index(
        op.f("ix_meal_plan_shopping_syncs_meal_plan_id"), table_name="meal_plan_shopping_syncs"
    )
