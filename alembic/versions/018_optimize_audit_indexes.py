"""Optimize audit module polymorphic indexes

Revision ID: 018_optimize_audit_indexes
Revises: 017_optimize_finance_user_index
Create Date: 2026-01-30 05:00:00.000000
...
def upgrade() -> None:
    ...
    op.create_index('ix_audit_logs_entity_history', 'audit_logs', ['entity_type', 'entity_id', 'occurred_at'], unique=False)
