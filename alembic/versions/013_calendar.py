...
down_revision: Union[str, None] = '012_gamification'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['linked_asset_id'], ['home_assets.id'], ),
        sa.ForeignKeyConstraint(['linked_pet_id'], ['pets.id'], ),
        sa.ForeignKeyConstraint(['linked_user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_calendar_events_group_id'), 'calendar_events', ['group_id'], unique=False)
